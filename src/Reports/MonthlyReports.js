...
class MonthlyReports extends Component {
    ...
    generateReport = () => {
        ...
        axios({
            method: 'POST',
            url: `${appUrl.REPORTS_URL}/cod-monthly`,
        })
        .then(res => {
        ...
        .catch(err => {
            console.log("Generate Monthly Report ", err);
        });
    }
        ...
        return (
            report && (
                <tr key={index}>
                    ...
                    {
                        permissions?.report?.monthly?.download &&
    ...
    render() {
        ...
        let totalReportCount = meta?.totalCount || 0;
                ...
                {/* <div className="row">
                    ...
                    <div className="col-xl-3">
                        <div className="card flex-row align-items-center common_card indivisual_orders">
                            ...
                            <div>
                                <h5 className="mb-0">{totalReportCount}</h5>
...
const mapStateToProps = (state) => {
    let filter = JSON.stringify("monthly");
...
export default connect(mapStateToProps, mapDispatchToProps)(MonthlyReports);
